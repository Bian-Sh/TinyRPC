...
#pragma warning restore 0649
        ...
        private void HideLogWindow(bool isHidePopup)
        {
            // Hide the log window
        ...
        bool logWindowVisible => logWindowCanvasGroup.interactable;

        public void SwitchPopupState()
        {
            if (logWindowVisible || popupManager.IsShow)
            {
                HideLogWindow(true);
            }
            else
